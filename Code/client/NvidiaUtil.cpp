...
HRESULT CreateEarlyDxDevice(ID3D11Device** appOutDevice, 
                            D3D_FEATURE_LEVEL* apInFeatureLevels, size_t aFeatureCount,
                            D3D_FEATURE_LEVEL* apOutFeatureLevel)
{
    return D3D11CreateDevice(nullptr, D3D_DRIVER_TYPE_HARDWARE, nullptr, 0, 
                             apInFeatureLevels, aFeatureCount,
                             D3D11_SDK_VERSION,
                             appOutDevice,
